...
interface IUserKeyListItemProps {
  keyId: string;
}

export default function UserKeyListItem({ keyId }: IUserKeyListItemProps) {
  ...
  return (
    <Link href={`/private/profile/${keyId}`} passHref>
      <div
        ...
        data-testid={`profile-link-${keyId}`}
      >
        <div
        ...
        <div className="flex-1">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="font-semibold text-lg" data-testid="username">
            ...
            <div className="font-light text-sm" data-testid="buy-price">
              {buyPrice} USDT
            </div>
          </div>
        </div>
