...
export function SellKeyModal({
  ...
  const keysBalance = useKeyCount({
    ethereumAddress,
    subjectEthereumAddress: keyAddress,
  });
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  <div className="mt-2">
                    ...
                    <p
                      ...
                      data-testid="keys-balance"
                    >
                      Keys owned: {keysBalance}
                    </p>
                    {alert && (
                      <p className="text-sm text-red-500 mb-4">{alert}</p>
                    )}
