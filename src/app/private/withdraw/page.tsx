        ...
        <div className="min-h-screen">
            ...
            <div className="max-w-sm mx-auto">
                <div className="mb-8 mt-16">
                    <label className="flex items-center text-gray-600 font-medium mb-2" htmlFor="destinationAddress">
                        Destination Address
                    </label>
                    <input
                        id="destinationAddress"
                        {...register("address", { required: "Withdraw address is required" })}
                        type="text"
                ...
                <form onSubmit={handleSubmit(withdraw)}>
                    <div className="mb-4">
                        <label className="flex items-center text-gray-600 font-medium mb-2" htmlFor="amount">
                            Amount to withdraw
                        </label>
                        <Controller
                            name="amount"
